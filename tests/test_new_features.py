...
from data.components.advanced_enemies import (
    PiranhaPlant, BulletBill, HammerBro, BuzzyBeetle, create_enemy
)
...
class TestAdvancedParticleSystem:
    ...
    def test_particle_templates_exist(self) -> None:
        ...
        expected_templates = [
            "jump_dust", "landing_dust", "shell_spark",
            "fireball_trail", "coin_burst", "combo_star"
        ]
...
class TestHintManager:
    ...
    def test_serialize_hint(self) -> None:
        ...
        hint = Hint(
            id="test",
            text="Test hint",
            category=HintCategory.CONTROLS,
