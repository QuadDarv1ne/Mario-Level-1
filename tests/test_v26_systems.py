...
# Import new modules
from data.player_progression import (
    ProgressionManager, PlayerStats, PlayerProfile,
    PlayerRank, Skill, SkillType
)
from data.skin_system import (
    SkinManager, Skin, SkinRarity, SkinCategory
)
from data.challenge_system import (
    ChallengeManager, Challenge, ChallengeType, ChallengeCategory, ChallengeStatus
)
from data.advanced_ai import (
    EnemyAI, GroupAI, AIDirector, EnemyAIConfig, AIBehavior, AlertState
)
...
class TestAdvancedAI:
    ...
    def test_ai_director_tension(self, mock_enemy) -> None:
        ...
        director.update(
            game_info,
            player_alive=True,
            player_health=0.1,  # Very low
            enemies_remaining=10  # Max
        )
